...
@ManagedBean
@ViewScoped
public class ParentSettingBean extends _BaseBean {
    ...
    public String saveExamType() {
        try {
            ...
            Logger.getLogger(ParentSettingBean.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String prepareForModify() {
        Logger.getLogger(ParentSettingBean.class.getName()).log(Level.INFO, "" + getExamType(), "");
        setEditMode("MODIFY");
        return "";
    }
