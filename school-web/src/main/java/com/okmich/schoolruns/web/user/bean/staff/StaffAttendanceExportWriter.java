 ...
 * @company Okmich Ltd.
 */
public class StaffAttendanceExportWriter extends BaseExportWriter {
     ...
     */
    public StaffAttendanceExportWriter(String reportTitle, String sheetLabel,
    ...
    protected void writeObject() throws TechnicalException {
        ...
        for (Employee emp : employees) {
            ...
            for (Date date : dates) {
                cell = row.createCell(colIndex++);
                empAttend = employeeAttendanceTable.getAttendance(emp, date);
                cell.setCellValue(getCreationHelper().createRichTextString(empAttend.getAttendanceId() == null ? "" : "x"));
            }
        }
    }
}