...
@ManagedBean
@ViewScoped
public class FinanceSettingBean extends _BaseBean {
    ...
    public String saveExamType() {
        try {
            ...
            Logger.getLogger(FinanceSettingBean.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String prepareForModify() {
        Logger.getLogger(FinanceSettingBean.class.getName()).log(Level.INFO, "" + getExamType(), "");
        setEditMode("MODIFY");
        return "";
    }
